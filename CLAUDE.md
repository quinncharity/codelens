...
- `CODELENS_DSPY_LM` — DSPy language model identifier (e.g. `xai/grok-code-fast-1`)
- An API key for the chosen provider (`XAI_API_KEY`, `OPENROUTER_API_KEY`, or `OPENAI_API_KEY`)
