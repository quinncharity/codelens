...
def test_parse_analysis_result_normalizes_and_drops_invalid_entries() -> None:
    result = parse_analysis_result(
        ...
        patterns_json='[{"name":"monorepo","category":"architecture","description":"uses workspaces","evidence_paths":["package.json","/abs/path"],"confidence":0.8},{"name":"x","category":"nope","description":"y","evidence_paths":[],"confidence":0.2},{"bad":true}]',
